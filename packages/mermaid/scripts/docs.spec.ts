  ...
  describe('buildShapeDoc', () => {
    it('should build shapesTable based on the shapeDefs', () => {
      expect(buildShapeDoc()).toMatchInlineSnapshot(`
        ...
        | C4 Browser                        | C4 Browser             | \`c4-browser\`   | Single-page application element in C4 model notation | \`c4browser\`                                                      |
        | C4 Bucket                         | C4 Bucket              | \`c4-bucket\`    | Object storage element in C4 model notation          | \`c4bucket\`                                                       |
        | C4 Database                       | C4 Database            | \`c4-database\`  | Database element in C4 model notation                | \`c4database\`                                                     |
        | C4 Folder                         | C4 Folder              | \`c4-folder\`    | Folder/directory element in C4 model notation        | \`c4folder\`                                                       |
        | C4 Person                         | C4 Person              | \`c4-person\`    | Person in C4 model notation (head and body)          | \`c4person\`                                                       |
        | C4 Queue                          | C4 Queue               | \`c4-queue\`     | Message queue element in C4 model notation           | \`c4queue\`                                                        |
        | C4 Terminal                       | C4 Terminal            | \`c4-terminal\`  | Server-side application element in C4 model notation | \`c4terminal\`                                                     |
